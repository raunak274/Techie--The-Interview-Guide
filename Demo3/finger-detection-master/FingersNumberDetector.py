...
class FingersNumberDetector:
    ...
    def startDetecting(self):
        ...
        while cap.isOpened():
            ...
            # cv2.rectangle(frame, (self.x0, self.y0), (self.x0 + self.width + 400, self.y0 + self.height + 800), (255, 207, 0), 2)

            cv2.rectangle(frame, (self.x0, self.y0), (self.x0 + self.width - 1, self.y0 + self.height - 1), (255, 0, 0),
                          2)
